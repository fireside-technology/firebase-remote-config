var capacitorPlugin = (function (exports, core) {
  ...
  class RestClient {
    ...
    async fetch(request) {
      ...
      try {
        ...
        if (
          ((_a = originalError) === null || _a === void 0
            ? void 0
            : _a.name) === "AbortError"
        ) {
        ...
        throw ERROR_FACTORY.create(errorCode, {
          originalErrorMessage:
            (_b = originalError) === null || _b === void 0
              ? void 0
              : _b.message,
        });
      }
    ...
    async delete(key) {
      ...
      return new Promise((resolve, reject) => {
        ...
        try {
          ...
          request.onerror = (event) => {
            reject(
              toFirebaseError(event, "storage-delete" /* STORAGE_DELETE */)
            );
          };
          request.onsuccess = () => {
            resolve();
  ...
  class StorageCache {
    ...
    setLastSuccessfulFetchTimestampMillis(timestampMillis) {
      ...
      return this.storage.setLastSuccessfulFetchTimestampMillis(
        timestampMillis
      );
    }
